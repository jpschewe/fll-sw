...
import fll.db.deliberations.NumAward;
 ...
 */
@WebServlet("/api/deliberation/NumAwards/*")
public class NumAwards extends HttpServlet {

  /**
   * Used for JSON deserialization.
   */
  private static final class TypeInformation extends TypeReference<Collection<NumAward>> {
    /** single instance. */
  ...
  protected final void doGet(final HttpServletRequest request,
    ...
    try (Connection connection = datasource.getConnection()) {
      ...
      final Collection<NumAward> v = NumAward.getNumAwards(connection, tournament);
  ...
  protected final void doPost(final HttpServletRequest request,
    ...
    try (Connection connection = datasource.getConnection()) {
      ...
      final Collection<NumAward> v = jsonMapper.readValue(request.getReader(), TypeInformation.INSTANCE);
      NumAward.setNumAwards(connection, tournament, v);
