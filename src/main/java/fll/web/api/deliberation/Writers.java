...
import fll.db.deliberations.Writer;
...
/**
 * Deliberation writers.
 */
@WebServlet("/api/deliberation/Writers/*")
public class Writers extends HttpServlet {

  /**
   * Used for JSON deserialization.
   */
  private static final class TypeInformation extends TypeReference<Collection<Writer>> {
    /** single instance. */
  ...
  protected final void doGet(final HttpServletRequest request,
    ...
    try (Connection connection = datasource.getConnection()) {
      ...
      final Collection<Writer> v = Writer.getWriters(connection, tournament);
  ...
  protected final void doPost(final HttpServletRequest request,
    ...
    try (Connection connection = datasource.getConnection()) {
      ...
      final Collection<Writer> v = jsonMapper.readValue(request.getReader(), TypeInformation.INSTANCE);
      Writer.setWriters(connection, tournament, v);
