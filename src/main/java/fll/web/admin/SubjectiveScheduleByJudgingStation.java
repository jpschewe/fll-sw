...
public class SubjectiveScheduleByJudgingStation extends BaseScheduleServlet {
  ...
  void outputSchedule(final Connection connection,
    ...
    ScheduleWriter.outputSubjectiveSchedulesByJudgingStation(schedule, output);
  }

  @Override
  String getFilename(Tournament tournament) {
    return String.format("%s_subjectiveByJudgingStation.pdf", tournament.getName());
  }
