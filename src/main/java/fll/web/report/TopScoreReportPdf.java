...
/**
 * Common code for top score reports.
 */
/* package */ abstract class TopScoreReportPdf extends BaseFLLServlet {
  ...
  protected final void outputReport(final OutputStream stream,
