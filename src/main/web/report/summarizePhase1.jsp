		...
		<c:choose>
			<c:when test="${not empty ERROR}">
				<p>There was an error summarizing the scores. The most common
					problem is that there are not enough scores in a judging group.
					Each group must have 2 or more scores that are not no shows.</p>
			...
			<c:otherwise>
				...
				<p>
					...
					groups for an award group, then the number of teams expected will
					be too high.
				</p>
