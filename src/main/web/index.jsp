...
<body>
    ...
    <ul>
        <li>
            ...
            follow this link on the performance score entry computers.
        </li>
        ...
        <li>
            <a href="<c:url value='/judges-room.jsp' />">Judges room</a>
            - follow this link on the judges room server
        </li>
    ...
    <ul>
        ...
        <li>
            <a href="<c:url value='/setup'/>">Database setup</a> - Use
            this link to upload a saved database
        </li>
        ...
        <li>
            <a href='BlankScoresheet'>Blank performance score sheet,
                one regular match play and one practice (PDF)</a>
        </li>
