...
<table border='0' cellpadding='0' cellspacing='0' width='98%'>
 <tr align='center'>
  <td colspan='5' bgcolor='<c:out value="${headerColor}"/>'><font
   size='3'> <b>Top Ten Performance Scores: Division <c:out
   value="${division}" /></b> </font></td>
 </tr>
 <!-- <tr>
 ...
 <tr>
  <td colspan='5' align='center'><!-- scores here -->
  <table border='1' bordercolor='#aaaaaa' cellpadding='4'
   ...
   %>
   <tr align='left'>
    <td width='7%' align='right'><font size='3'> <%=rank%> </font>
    </td>
    <td width='10%' align='right'><font size='3'> <%=rs.getInt("TeamNumber")%>
    </font></td>
    <td width='28%'><font size='3'> <%
