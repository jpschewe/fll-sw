...
public class FinalistSchedulerUI extends BaseFLLServlet {
  ...
  protected void processRequest(final HttpServletRequest request,
    ...
    try {
      ...
      if (null != request.getParameter("num-finalists")) {
        ...
        displayProposedFinalists(response, connection, challengeDocument, numFinalists, division, extraCategoryFinalists);
        return;
  ...
  private void displayProposedFinalists(final HttpServletResponse response,
                                        ...
                                        final String division,
                                        final Map<String, List<Integer>> divisionFinalists) throws IOException {
