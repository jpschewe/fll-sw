 ...
 */
@WebServlet("/report/finalist/PrivateFinalistSchedule")
public class PrivateFinalistSchedule extends AbstractFinalistSchedule {
  ...
  protected void processRequest(final HttpServletRequest request,
    ...
    processRequest(division, true, response, application);
  }
