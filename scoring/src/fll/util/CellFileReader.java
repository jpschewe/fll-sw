...
public abstract class CellFileReader implements Closeable {
  ...
  /**
   * Open file and create the appropriate cell reader for it. If this file is a spreadsheet, then
   ...
   */
  public static CellFileReader createCellReader(final File file, final String sheetName) throws InvalidFormatException, IOException {
