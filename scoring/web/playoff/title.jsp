...
<%
	...
	if (null != displayName) {
		sessionDivision = (String) application.getAttribute(displayName + "_" + divisionKey);
		sessionRoundNumber = (Number) application.getAttribute(displayName + "_" + roundNumberKey);
	} else {
	...
	if (null != sessionDivision) {
		...
		if (!divisions.isEmpty()) {
			...
			throw new RuntimeException("No head to head bracket specified and no divisions in the database!");
		}
	} else {
...
<body style="background: white">
	...
	<table border='0' cellpadding='0' cellspacing='0' width='98%'>
		<tr>
			<td align='center'><font face='arial' size='3'><b>${challengeDescription.title }
						(Head to Head Round <%=playoffRoundNumber%>, Head to Head Bracket
						<%=division%>)
				</b></font></td>
		</tr>
		<tr>
			<td align='center'><font face='arial' size='3'> <b><c:out
							value="${ScorePageText}" /></b>
			</font></td>
		</tr>
	</table>
