...
<body>
  ...
  <ol>
    ...
    <li><a
      href='FinalComputedScores'
      target="_blank">Final Computed Scores</a>. This is the report that
      the head judge will want to determine which teams advance to the
      next tournament.</li>

    <li><a
      href="CategoryScoresByScoreGroup"
      target="_blank">Categorized Scores by Judging Group</a>. This
      displays the scaled scores for each category by judging group.
      This is useful for checking the winners of each category.</li>

    <li><a
      href="RankingReport"
      target="_blank">Ranking Report for teams</a>. This is printed at
      the end of the day and each team gets their page.</li>

    <li><a
      href="PerformanceScoreReport"
      target="_blank">Performance Score Report</a>. This displays the
      details of the performance runs for each team.</li>

    <li><a
      href="PlayoffReport"
      target="_blank">Winners of each head to head bracket</a>. This is
      useful for the awards ceremony.</li>
