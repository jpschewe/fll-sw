...
<body>
 ...
 <p>
  This software is licensed by INSciTE under the <a href="LICENSE.txt">GPL</a>
 </p>
 ...
 <ul>
  ...
  <li><a href="http://jakarta.apache.org/tomcat/index.html">Apache
    Tomcat</a> - <a href="tomcat-license.txt">License</a></li>

  <li><a href="http://java.sun.com/">Java Development Kit</a> - <a
   href="jdk-license.txt">License</a></li>
  ...
  <li><a href="http://jakarta.apache.org/commons/fileupload/">Jakarta
    Commons Fileupload</a> - <a href="commons-fileupload-LICENSE.txt">License</a></li>

  <li><a href="http://hsqldb.org">HSQLDB</a> - <a
   href="hsqldb-license.txt">License</a></li>

  <li><a href="http://logging.apache.org/log4j/docs/">Log4j</a> - <a
   href="log4j-license.txt">License</a></li>

  <li><a href="http://jstl.java.net/">JSTL 1.2</a> - <a
   href="jstl-1.2-license.txt">License</a></li>
  ...
  <li><a href="http://www.jstorage.info/">jStorage</a> - <a
   href="jstorage.license.txt">License</a></li>

  <li><a href="http://wiki.fasterxml.com/JacksonHome">Jackson
    JSON Processor</a> - <a href="apache-license-2.0.txt">License</a></li>

  <li><a href="https://github.com/flesler/jquery.scrollTo">jQuery
    ScrollTo</a> - <a href="jQuery-ScrollTo-LICENSE.txt">License</a></li>

  <li><a href="http://icepush.org/">ICEpush</a> - <a
   href="icepush-license.txt">License</a></li>

  <li><a href="https://github.com/jpschewe/opencsv-jps">OpenCSV</a>
   - <a href="opencsv-license.txt">License</a></li>

  <li><a href="http://schemaspy.sourceforge.net/">SchemaSpy to
    generate the database diagram</a> - <a href="schemaspy-license.txt">License</a></li>
